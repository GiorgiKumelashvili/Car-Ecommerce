        ...
        <div class="col-12 col-md-10 col-xl-6">
            ...
            <div class="row py-5 justify-content-between">
                <div class="col-md-6 d-flex align-items-center justify-content-center">
                    ...
                    <h4 class="m-0 pl-3 text-primary h5">
                        (+995) 551 19 47 73
                    </h4>
                </div>

                <div class="col-md-6 pt-3 pt-md-0 d-flex align-items-center justify-content-center">
                    <div
                        class="p-3 border border-primary text-primary rounded-circle d-flex justify-content-center align-items-center"
                        style="width: 60px;height: 60px">
            ...
            <form method="POST" class="pt-5" action="{{route('sendMail')}}">
                @csrf
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input
                            type="text"
                            name="name_surname"
                            class="form-control border quad-rounded-less {{$errors->has('name_surname') ? "border-danger" : ""}}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input
                            ...
                            name="email"
                            class="form-control border quad-rounded-less {{$errors->has('email') ? "border-danger" : ""}}"
                            value="{{old('email')}}"
                        >
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea
                            ...
                            name="letter"
                            class="form-control border quad-rounded-less {{$errors->has('letter') ? "border-danger" : ""}}"
                        >{{old('letter')}}</textarea>
